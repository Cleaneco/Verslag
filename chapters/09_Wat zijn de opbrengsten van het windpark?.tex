...
Het parkeffect varieert afhankelijk van de vermogensdichtheid. Deze is op zijn beurt weer afhankelijk van meerdere factoren. De berekende waardes van het parkeffect voor verschillende aantallen turbines staan in figuur \ref{fig:Parkeffect_table} en is geplot in (figuur \ref{fig:ParkEffectGraph}). 
...
\end{equation}
\myequations{Berekening: Pdichtheid18MW }
...
\end{equation}
\myequations{Berekening: Pdichtheid12MW}
...
\end{equation}
\myequations{Berekening: Peffect18MW}
...
\end{equation}
\myequations{Berekening: Peffect12MW}
...
\end{equation}
\myequations{Berekening: Opbrengsteffect18MW}
...
\end{equation}
\myequations{Berekening: Opbrengsteffect12MW}
